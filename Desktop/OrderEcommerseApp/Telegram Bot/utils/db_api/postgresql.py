...
class Database:
    ...
    async def add_user(self, telegram_id, username, first_name, last_name, phone_number, lang, birth_date, is_courier):
        sql = ("INSERT INTO Users_user (telegram_id, username, first_name, last_name, phone_number, language, birth_date, is_courier) "
